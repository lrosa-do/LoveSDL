...
#else
#define RL_MALLOC(sz)       dmt_malloc(sz)
#define RL_CALLOC(n,sz)     dmt_calloc(n,sz)
#define RL_REALLOC(ptr,sz)  dmt_realloc(ptr,sz)
#define RL_FREE(ptr)        dmt_free(ptr)
#endif // USE_DMT
...
int bezierRGBA(SDL_Renderer * renderer, const Sint16 * vx, const Sint16 * vy, int n, int s);
